...
public class BD {
	...
	private static final String NOMBRETABLA = "Elecciones";
	private static final String COLUMNAS_TABLA = " (nombre string, numeroVotos integer)";
	 ...
	 */
	public static boolean eleccionesInsert( Statement st, String nombre, int numeroVotos ) {
		String sentSQL = "";
		try {
			sentSQL = "insert into analitica values('" + secu(nombre) + "', " + numeroVotos + ")";
	 ...
	 */
	public static int analiticaSelect( Statement st, String nombre ) {
		String sentSQL = "";
		try {
			int ret = Integer.MAX_VALUE;
			sentSQL = "select * from analitica where codigo='" + nombre + "'";
			ResultSet rs = st.executeQuery( sentSQL );
			if (rs.next()) {
				ret = rs.getInt( "Nombre" );
			}
			rs.close();
	 ...
	 * @return	true si la inserci�n es correcta, false en caso contrario
	 */
	public static boolean analiticaUpdate( Statement st, String nombre, int numeroVotos ) {
		String sentSQL = "";
		try {
			sentSQL = "update analitica set contador=" + nombre + " where codigo='" + numeroVotos + "'";
			int val = st.executeUpdate( sentSQL );
	 ...
	 */
	public static boolean analiticaDelete( Statement st, String nombre ) {
		String sentSQL = "";
		try {
			sentSQL = "delete from analitica where codigo='" + secu(nombre) + "'";
			int val = st.executeUpdate( sentSQL );
